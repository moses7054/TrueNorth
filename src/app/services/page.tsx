...
const services = [
  {
    title: "Planning",
    description:
      "Comprehensive project planning and design services to ensure your vision becomes reality.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Tile Work",
    description:
      "Expert tile installation and repair services for floors, walls, and more.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    ...
    description:
      "Professional air conditioning installation and maintenance services.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Electrical",
    description:
      "Complete electrical services including installation, repair, and maintenance.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  },
  {
    title: "Welding",
    description:
      "Professional welding services for various construction needs.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  {
    title: "Grill Work",
    description: "Custom grill work and metal fabrication services.",
    icon: (
      <svg
        className="w-6 h-6"
        fill="none"
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      >
        ...
        >
          Comprehensive construction and renovation services tailored to your
          needs. From planning to completion, we handle every aspect of your
          project.
        </motion.p>
      </motion.div>
      ...
      >
        <motion.div variants={itemVariants}>
          <Link
            href="/contact"
            className="inline-block bg-[#1a365d] text-white px-8 py-4 rounded-lg hover:bg-[#2c5282] transition-colors shadow-lg hover:shadow-xl font-medium"
          >
            Get a Quote
          </Link>
        </motion.div>
